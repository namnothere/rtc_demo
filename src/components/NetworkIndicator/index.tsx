...
import { NetworkQuality } from '@byteplus/rtc';
...
const INDICATOR_TEXT = {
  ...
  [NetworkQuality.VBAD]: 'Very Bad',
  [NetworkQuality.DOWN]: 'Very Bad',
};
      ...
      content={
        <div className={style.panel}>
          <div className={style.label}>
            <div className={style.state}>Status</div>
            <div className={style.item}>Delay</div>
            <div className={style.item}>Loss rate</div>
          </div>
